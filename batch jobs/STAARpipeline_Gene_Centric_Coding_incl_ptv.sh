...
/n/home05/zilinli/R-3.6.1/bin/Rscript --slave --no-restore --no-save STAARpipeline_Gene_Centric_Coding_incl_ptv.r ${SLURM_ARRAY_TASK_ID} > out_incl_ptv"${SLURM_ARRAY_TASK_ID}".Rout
