...
start_time <- Sys.time()
AI_results_noncoding <- Gene_Centric_Noncoding(chr, gene_name, genofile, obj_nullmodel, category = category,
...
save(AI_results_noncoding,file=paste0(output_path, output_file_name, "_", chr, "_", gene_name, "_", category,".Rdata"))
